...
// Note: callback.grpc.pb.h would be generated from callback.proto
// For now we'll use forward declarations and stubs
#endif
...
private:
    ...
    GRPCMainInterface * mMainInterface = nullptr;
