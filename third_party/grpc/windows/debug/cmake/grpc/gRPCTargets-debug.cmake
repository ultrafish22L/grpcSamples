...
set_target_properties(gRPC::address_sorting PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/address_sorting.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::address_sorting )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::address_sorting "${_IMPORT_PREFIX}/debug/address_sorting.lib" )
...
set_target_properties(gRPC::gpr PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/gpr.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::gpr )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::gpr "${_IMPORT_PREFIX}/debug/gpr.lib" )
...
set_target_properties(gRPC::grpc PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpc.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc "${_IMPORT_PREFIX}/debug/grpc.lib" )
...
set_target_properties(gRPC::grpc_unsecure PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C;CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpc_unsecure.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc_unsecure )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc_unsecure "${_IMPORT_PREFIX}/debug/grpc_unsecure.lib" )
...
set_target_properties(gRPC::upb_base_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/upb_base_lib.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::upb_base_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::upb_base_lib "${_IMPORT_PREFIX}/debug/upb_base_lib.lib" )
...
set_target_properties(gRPC::upb_json_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/upb_json_lib.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::upb_json_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::upb_json_lib "${_IMPORT_PREFIX}/debug/upb_json_lib.lib" )
...
set_target_properties(gRPC::upb_mem_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/upb_mem_lib.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::upb_mem_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::upb_mem_lib "${_IMPORT_PREFIX}/debug/upb_mem_lib.lib" )
...
set_target_properties(gRPC::upb_message_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/upb_message_lib.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::upb_message_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::upb_message_lib "${_IMPORT_PREFIX}/debug/upb_message_lib.lib" )
...
set_target_properties(gRPC::upb_mini_descriptor_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/upb_mini_descriptor_lib.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::upb_mini_descriptor_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::upb_mini_descriptor_lib "${_IMPORT_PREFIX}/debug/upb_mini_descriptor_lib.lib" )
...
set_target_properties(gRPC::upb_textformat_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/upb_textformat_lib.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::upb_textformat_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::upb_textformat_lib "${_IMPORT_PREFIX}/debug/upb_textformat_lib.lib" )
...
set_target_properties(gRPC::upb_wire_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/upb_wire_lib.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::upb_wire_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::upb_wire_lib "${_IMPORT_PREFIX}/debug/upb_wire_lib.lib" )
...
set_target_properties(gRPC::utf8_range_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/utf8_range_lib.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::utf8_range_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::utf8_range_lib "${_IMPORT_PREFIX}/debug/utf8_range_lib.lib" )
...
set_target_properties(gRPC::grpc++_alts PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpc++_alts.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc++_alts )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc++_alts "${_IMPORT_PREFIX}/debug/grpc++_alts.lib" )
...
set_target_properties(gRPC::grpc++_error_details PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpc++_error_details.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc++_error_details )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc++_error_details "${_IMPORT_PREFIX}/debug/grpc++_error_details.lib" )
...
set_target_properties(gRPC::grpc++_reflection PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpc++_reflection.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc++_reflection )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc++_reflection "${_IMPORT_PREFIX}/debug/grpc++_reflection.lib" )
...
set_target_properties(gRPC::grpc++_unsecure PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpc++_unsecure.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc++_unsecure )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc++_unsecure "${_IMPORT_PREFIX}/debug/grpc++_unsecure.lib" )
...
set_target_properties(gRPC::grpc_authorization_provider PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C;CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpc_authorization_provider.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc_authorization_provider )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc_authorization_provider "${_IMPORT_PREFIX}/debug/grpc_authorization_provider.lib" )
...
set_target_properties(gRPC::grpc_plugin_support PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpc_plugin_support.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc_plugin_support )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc_plugin_support "${_IMPORT_PREFIX}/debug/grpc_plugin_support.lib" )
...
set_target_properties(gRPC::grpcpp_channelz PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/grpcpp_channelz.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpcpp_channelz )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpcpp_channelz "${_IMPORT_PREFIX}/debug/grpcpp_channelz.lib" )
