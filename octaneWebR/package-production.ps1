...
Write-Host "🌐 Open http://localhost:43930 in your browser" -ForegroundColor Yellow
Write-Host ""
...
if ($pythonCmd) {
    ...
    Write-Host "❌ Error: Python not found. Please install Python or use Node.js:" -ForegroundColor Red
