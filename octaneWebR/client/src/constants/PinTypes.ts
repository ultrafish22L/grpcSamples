...
export const pinIconMapping: Record<string, PinIconInfo> = {
  ...
  'PT_ENUM': {
    icon: '/icons/VALUE INT node.png', // Uses INT icon
    color: '#88FF44'
  },
  ...
  'PT_ROUND_EDGES': {
    icon: '/icons/ROUND_EDGES_IN node.png',
    color: '#FF44FF'
  },
  ...
  'PT_LUT': {
    icon: '/icons/LUT_SWITCH node.png',
    color: '#8844FF'
  },
  'PT_RENDER_JOB': {
    icon: '/icons/RENDER_JOB_IN node.png',
    color: '#FF8888'
  },
  'PT_TOON_RAMP': {
    icon: '/icons/TOON_RAMP_IN node.png',
    color: '#FFAA44'
  },
  'PT_VOLUME_RAMP': {
    icon: '/icons/VOLUME_RAMP_IN node.png',
    color: '#44AAFF'
  },
  'PT_BIT_MASK': {
    icon: '/icons/BITMASK_SWITCH node.png',
    color: '#888888'
  },
  ...
  // OCIO types
  'PT_OCIO_VIEW': {
    icon: '/icons/OCIO_VIEW_SWITCH node.png',
    color: '#FF88AA'
  },
  'PT_OCIO_LOOK': {
    icon: '/icons/OCIO_LOOK_SWITCH node.png',
    color: '#88AAFF'
  },
  'PT_OCIO_COLOR_SPACE': {
...
export function getPinIconInfo(pinType: string): PinIconInfo {
  return pinIconMapping[pinType] || pinIconMapping['PT_UNKNOWN'];
}
