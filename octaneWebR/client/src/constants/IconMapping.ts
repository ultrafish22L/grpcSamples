...
export const NODE_TYPE_ICON_MAP: IconMapping = {
  ...
  'NT_RENDER_AOV_OUT': 'aov-output.png',
  'NT_RENDER_AOV_SWITCH': 'aov-output.png',
  'NT_RENDER_JOB': 'RENDER JOB node.png',
  'NT_RENDER_LAYER': 'render_layer.png',
  'NT_RENDER_LAYER_MASK_AOV': 'render_layer.png',
  'NT_RENDER_PASSES': 'render_layer.png',
  'NT_RENDER_TARGET': 'RENDER TARGET node.png',
  'NT_RENDER_TARGET_IN': 'RENDER TARGET node.png',
  'NT_RENDER_TARGET_OUT': 'RENDER TARGET node.png',
  'NT_RENDER_TARGET_SWITCH': 'RENDER TARGET node.png',

  // Output AOVs
  'NT_OUT_ALPHA_SHADOW': 'aov-output-group.png',
  'NT_OUT_AMBIENT_LIGHT': 'aov-output-group.png',
  'NT_OUT_BACKGROUND': 'aov-output-group.png',
  'NT_OUT_BEAUTY': 'aov-output-group.png',
  'NT_OUT_CRYPTOMATTE': 'aov-output-group.png',
  'NT_OUT_CUSTOM_AOV': 'CUSTOM_AOV node.png',
  'NT_OUT_DENOISER_AOV': 'aov-output-group.png',
  'NT_OUT_DIFFUSE_DIRECT': 'aov-output-group.png',
  'NT_OUT_DIFFUSE_FILTER': 'aov-output-group.png',
  'NT_OUT_DIFFUSE_INDIRECT': 'aov-output-group.png',
  'NT_OUT_EMISSION': 'aov-output-group.png',
  'NT_OUT_GEOMETRIC_NORMAL': 'aov-output-group.png',
  'NT_OUT_INFO_PASS': 'aov-output-group.png',
  'NT_OUT_IRRADIANCE': 'aov-output-group.png',
  'NT_OUT_LIGHT_PASS': 'aov-output-group.png',
  'NT_OUT_MATERIAL_PASS': 'aov-output-group.png',
  'NT_OUT_MATTE_SHADOW': 'aov-output-group.png',
  'NT_OUT_NORMALS': 'aov-output-group.png',
  'NT_OUT_OBJECT_LAYER': 'aov-output-group.png',
  ...
  'NT_OUT_OPACITY': 'aov-output-group.png',
  'NT_OUT_OUTLINE': 'aov-output-group.png',
  'NT_OUT_POST_PROCESSING': 'POSTPROC node.png',
  'NT_OUT_REFLECTION': 'aov-output-group.png',
  'NT_OUT_REFRACTION': 'aov-output-group.png',
  'NT_OUT_REMAINDER': 'aov-output-group.png',
  'NT_OUT_RENDER_LAYER_ID': 'aov-output-group.png',
  'NT_OUT_ROUGHNESS': 'aov-output-group.png',
  'NT_OUT_SAMPLING': 'aov-output-group.png',
  'NT_OUT_SHADING_NORMAL': 'aov-output-group.png',
  'NT_OUT_SHADOW': 'aov-output-group.png',
  'NT_OUT_SPECULAR_DIRECT': 'aov-output-group.png',
  'NT_OUT_SPECULAR_INDIRECT': 'aov-output-group.png',
  'NT_OUT_SUB_SURFACE_SCATTERING': 'aov-output-group.png',
  'NT_OUT_TANGENT_NORMAL': 'aov-output-group.png',
  'NT_OUT_TOON': 'aov-output-group.png',
  'NT_OUT_TRANSMISSION': 'aov-output-group.png',
  'NT_OUT_UV_COORDS': 'aov-output-group.png',
  'NT_OUT_VELOCITY': 'aov-output-group.png',
  'NT_OUT_VOLUME_EMISSION': 'aov-output-group.png',
  'NT_OUT_VOLUME_Z_DEPTH': 'aov-output-group.png',
  'NT_OUT_WIREFRAME': 'aov-output-group.png',
  'NT_OUT_Z_DEPTH': 'aov-output-group.png',
  ...
  'NT_ANIMATION_SETTINGS_IN': 'animation_settings_node.png',
  'NT_ANIMATION_SETTINGS_OUT': 'animation_settings_node.png',
  'NT_ANIMATION_SETTINGS_SWITCH': 'animation_settings_node.png',
