...
namespace OctaneWrap
{
    ...
    public:
        ...
        virtual void onInit(
            Octane::ApiGridLayout &parentGrid) = 0;
    ...
    private:
        ...
        static void* initCallback(
            Octane::ApiGridLayout *parentGrid);
...
{
        Octane::ApiWorkPaneModuleInfo *info = Octane::ApiWorkPaneModuleInfo::create(
        ...
        if (isStaticallyLinked)
        {
            ...
            Octane::registerStaticWorkPaneModule(*info);
        }
        else
        {
            // register as dynamically linked module
            Octane::registerWorkPaneModule(*info);
        }
