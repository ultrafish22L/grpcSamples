...
#include "octanewrapmouselistener.h"
// myself
...
:
    mComponent(NULL)
{
    mApiMouseListener = Octane::ApiMouseListener::create(
...
Octane::ApiGuiComponent* GuiComponent::wrappedComponent()
{
    return mComponent;
}


const Octane::ApiGuiComponent* GuiComponent::wrappedComponent() const
{
    return mComponent;
}
    ...
    MouseListener *newListener)
{
    ...
    {
        mComponent->addMouseListener(mApiMouseListener);
    }
