...
void makeSimpleScene(
    ApiNodeProxy * renderTargetNode)
{
    ApiRootNodeGraphProxy projectRoot = ApiProjectManagerProxy::rootNodeGraph();
    ApiNodeProxy geoGroup = renderTargetNode->connectedNode(Octane::P_MESH, false);
    ...
    renderTargetNode->connectTo(Octane::P_CAMERA, &camera, true, false);
    ...
    renderTargetNode->connectTo(Octane::P_ENVIRONMENT, &env, true, false);
    ...
    renderTargetNode->connectTo(Octane::P_KERNEL, &kernel, true, false);
}
...
void OnNewImageCallback(
    const  ApiArray<Octane::ApiRenderImage> & renderImages2,
    void *                                    userData)
{
    ...
    {
        const Octane::ApiRenderImage & renderImage = renderImages[i]; 
...
void renderScene()
{
    try
    {
        ...
        */
        ...
        ApiProjectManagerProxy::resetProject(true);
        ApiRootNodeGraphProxy projectRoot = ApiProjectManagerProxy::rootNodeGraph();
        ...
        ApiNodeProxy filmSettings = gRenderTarget.inputNode(Octane::P_FILM_SETTINGS, false);
        ApiNodeProxy resolution   = filmSettings.inputNode(Octane::P_RESOLUTION, false);
        OctaneVec::int32_2 res = {1024,1024};
        resolution.set(Octane::A_VALUE, res, false);
    ...
    const octaneapi::StreamCallbackRequest & request)
{
    ...
    switch (request.payload_case())
    {
        ...
        case octaneapi::StreamCallbackRequest::kNewImage:
        {
            ...
            const OnNewImageData & img = request.newimage(); //  use correct field name
