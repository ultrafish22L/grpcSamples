...
"$PROTOC" -I "$PROTODEFS" --grpc_out=./proto_objc_out --plugin=protoc-gen-grpc="$GRPC_PLUGIN" "$PROTODEFS"apigaussiansplatting.proto
"$PROTOC" -I "$PROTODEFS" --objc_out=./proto_objc_out "$PROTODEFS"apigaussiansplatting.proto
