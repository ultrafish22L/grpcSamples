...
FileName::FileName()
:
    mApiFileName(Octane::ApiFileName::create())
{}
...
FileName::FileName(
    const char *str)
:
    mApiFileName(Octane::ApiFileName::create(str))
{}
...
:
    mApiFileName(Octane::ApiFileName::create(str.c_str()))
{}
...
:
    mApiFileName(Octane::ApiFileName::create(other.getFullString().c_str()))
{}
