 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::octaneapi::ApiItemArray_getResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::octaneapi::ApiItemArray_getResponse>> Asyncget1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::octaneapi::ApiItemArray_getResponse>>(Asyncget1Raw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::octaneapi::ApiItemArray_getResponse>> PrepareAsyncget1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::octaneapi::ApiItemArray_getResponse>>(PrepareAsyncget1Raw(context, request, cq));
    }
    ...
    class async_interface {
     public:
      ...
      // / Returns the item at the given index
      virtual void get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // / Returns the internal array (owned by this object)
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::octaneapi::ApiItemArray_getResponse>* Asyncget1Raw(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::octaneapi::ApiItemArray_getResponse>* PrepareAsyncget1Raw(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::octaneapi::ApiItemArray_getResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::octaneapi::ApiItemArray_getResponse>> Asyncget1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::octaneapi::ApiItemArray_getResponse>>(Asyncget1Raw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::octaneapi::ApiItemArray_getResponse>> PrepareAsyncget1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::octaneapi::ApiItemArray_getResponse>>(PrepareAsyncget1Raw(context, request, cq));
    }
    ...
    class async final :
     ...
     public:
      ...
      void get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response, std::function<void(::grpc::Status)>) override;
      void get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::octaneapi::ApiItemArray_getResponse>* Asyncget1Raw(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::octaneapi::ApiItemArray_getResponse>* PrepareAsyncget1Raw(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // / Returns the item at the given index
    virtual ::grpc::Status get1(::grpc::ServerContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response);
    // / Returns the internal array (owned by this object)
  ...
  class WithAsyncMethod_get1 : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status get1(::grpc::ServerContext* /*context*/, const ::octaneapi::ApiItemArray_getRequest* /*request*/, ::octaneapi::ApiItemArray_getResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void Requestget1(::grpc::ServerContext* context, ::octaneapi::ApiItemArray_getRequest* request, ::grpc::ServerAsyncResponseWriter< ::octaneapi::ApiItemArray_getResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_size<WithAsyncMethod_get1<WithAsyncMethod_items<WithAsyncMethod_begin1<WithAsyncMethod_end1<WithAsyncMethod_init<Service > > > > > > AsyncService;
  template <class BaseClass>
    ...
    WithCallbackMethod_get1() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::octaneapi::ApiItemArray_getRequest, ::octaneapi::ApiItemArray_getResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response) { return this->get1(context, request, response); }));}
  ...
  typedef WithCallbackMethod_size<WithCallbackMethod_get1<WithCallbackMethod_items<WithCallbackMethod_begin1<WithCallbackMethod_end1<WithCallbackMethod_init<Service > > > > > > CallbackService;
  ...
  class WithStreamedUnaryMethod_get1 : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status Streamedget1(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::octaneapi::ApiItemArray_getRequest,::octaneapi::ApiItemArray_getResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_size<WithStreamedUnaryMethod_get1<WithStreamedUnaryMethod_items<WithStreamedUnaryMethod_begin1<WithStreamedUnaryMethod_end1<WithStreamedUnaryMethod_init<Service > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_size<WithStreamedUnaryMethod_get1<WithStreamedUnaryMethod_items<WithStreamedUnaryMethod_begin1<WithStreamedUnaryMethod_end1<WithStreamedUnaryMethod_init<Service > > > > > > StreamedService;
};
