...
static const char* ApiRenderEngineService_method_names[] = {
  ...
  "/octaneapi.ApiRenderEngineService/freeRenderImages",
...
ApiRenderEngineService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_freeRenderImages_(ApiRenderEngineService_method_names[48], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getRenderStatistics_(ApiRenderEngineService_method_names[49], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getRenderResultStatistics_(ApiRenderEngineService_method_names[50], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveImage_(ApiRenderEngineService_method_names[51], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveImage1_(ApiRenderEngineService_method_names[52], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveImage2_(ApiRenderEngineService_method_names[53], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveRenderPasses_(ApiRenderEngineService_method_names[54], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveRenderPasses1_(ApiRenderEngineService_method_names[55], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveRenderPasses2_(ApiRenderEngineService_method_names[56], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveRenderPassesMultiExr_(ApiRenderEngineService_method_names[57], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveRenderPassesMultiExr1_(ApiRenderEngineService_method_names[58], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveRenderPassesDeepExr_(ApiRenderEngineService_method_names[59], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deepImageEnabled_(ApiRenderEngineService_method_names[60], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deepImageEnabled1_(ApiRenderEngineService_method_names[61], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deepPassesEnabled_(ApiRenderEngineService_method_names[62], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_canSaveDeepImage_(ApiRenderEngineService_method_names[63], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveDeepImage_(ApiRenderEngineService_method_names[64], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveRenderState_(ApiRenderEngineService_method_names[65], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_loadRenderState_(ApiRenderEngineService_method_names[66], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_previewMaterial_(ApiRenderEngineService_method_names[67], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_previewMaterialHdr_(ApiRenderEngineService_method_names[68], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_previewMaterial1_(ApiRenderEngineService_method_names[69], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getMemoryUsage_(ApiRenderEngineService_method_names[70], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getResourceStatistics_(ApiRenderEngineService_method_names[71], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getGeometryStatistics_(ApiRenderEngineService_method_names[72], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getTexturesStatistics_(ApiRenderEngineService_method_names[73], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getSceneBounds_(ApiRenderEngineService_method_names[74], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getDeviceCount_(ApiRenderEngineService_method_names[75], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getDeviceComputeModel_(ApiRenderEngineService_method_names[76], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getDeviceName_(ApiRenderEngineService_method_names[77], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_isSupportedDevice_(ApiRenderEngineService_method_names[78], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deviceCanRender_(ApiRenderEngineService_method_names[79], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deviceCanDenoise_(ApiRenderEngineService_method_names[80], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deviceSupportsHardwareRayTracing_(ApiRenderEngineService_method_names[81], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deviceSharedSurfaceInfo_(ApiRenderEngineService_method_names[82], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getAvailablePeerToPeerPairs_(ApiRenderEngineService_method_names[83], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_setDevicesActivity_(ApiRenderEngineService_method_names[84], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_isDeviceUsedForRendering_(ApiRenderEngineService_method_names[85], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deviceUsesPriority_(ApiRenderEngineService_method_names[86], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_deviceUsesHardwareRayTracing_(ApiRenderEngineService_method_names[87], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_imageDeviceIndex_(ApiRenderEngineService_method_names[88], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_isDeviceUsedForDenoising_(ApiRenderEngineService_method_names[89], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_renderPriority_(ApiRenderEngineService_method_names[90], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_setRenderPriority_(ApiRenderEngineService_method_names[91], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_currentPeerToPeerGroups_(ApiRenderEngineService_method_names[92], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_hardwareRayTracingEnabled_(ApiRenderEngineService_method_names[93], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_openDeviceSettings_(ApiRenderEngineService_method_names[94], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_renderDeviceState_(ApiRenderEngineService_method_names[95], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_renderDeviceErrorCode_(ApiRenderEngineService_method_names[96], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_errorcodeToString_(ApiRenderEngineService_method_names[97], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_renderDeviceErrorMessage_(ApiRenderEngineService_method_names[98], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_saveRenderDeviceConfig_(ApiRenderEngineService_method_names[99], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_outOfCoreEnabled_(ApiRenderEngineService_method_names[100], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_enableOutOfCore_(ApiRenderEngineService_method_names[101], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_disableOutOfCore_(ApiRenderEngineService_method_names[102], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getOutOfCoreMemoryUsage_(ApiRenderEngineService_method_names[103], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_setGpuHeadroom_(ApiRenderEngineService_method_names[104], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getGpuHeadroom_(ApiRenderEngineService_method_names[105], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_setCoreLimit_(ApiRenderEngineService_method_names[106], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_disableCoreLimit_(ApiRenderEngineService_method_names[107], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_registerInputSharedSurface_(ApiRenderEngineService_method_names[108], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_unregisterInputSharedSurface_(ApiRenderEngineService_method_names[109], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_triggerAsyncTonemap_(ApiRenderEngineService_method_names[110], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_setSharedSurfaceOutputType_(ApiRenderEngineService_method_names[111], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getSharedSurfaceOutputType_(ApiRenderEngineService_method_names[112], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getRealTime_(ApiRenderEngineService_method_names[113], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_pauseRendering_(ApiRenderEngineService_method_names[114], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_continueRendering_(ApiRenderEngineService_method_names[115], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_isRenderingPaused_(ApiRenderEngineService_method_names[116], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_restartRendering_(ApiRenderEngineService_method_names[117], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_stopRendering_(ApiRenderEngineService_method_names[118], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_pick_(ApiRenderEngineService_method_names[119], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_pickWhitePoint_(ApiRenderEngineService_method_names[120], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_pickImagerWhitePoint_(ApiRenderEngineService_method_names[121], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_isOutputAovWhitePointPickable_(ApiRenderEngineService_method_names[122], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_pickOutputAovWhitePoint_(ApiRenderEngineService_method_names[123], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_pickCryptomatteMatte_(ApiRenderEngineService_method_names[124], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_modifyCryptomatteMatteSelection_(ApiRenderEngineService_method_names[125], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_toString_(ApiRenderEngineService_method_names[126], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getDevicePciIds_(ApiRenderEngineService_method_names[127], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status ApiRenderEngineService::Stub::freeRenderImages(::grpc::ClientContext* context, const ::octaneapi::ApiRenderEngine_freeRenderImagesRequest& request, ::octaneapi::ApiRenderEngine_freeRenderImagesResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::octaneapi::ApiRenderEngine_freeRenderImagesRequest, ::octaneapi::ApiRenderEngine_freeRenderImagesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_freeRenderImages_, context, request, response);
}

void ApiRenderEngineService::Stub::async::freeRenderImages(::grpc::ClientContext* context, const ::octaneapi::ApiRenderEngine_freeRenderImagesRequest* request, ::octaneapi::ApiRenderEngine_freeRenderImagesResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::octaneapi::ApiRenderEngine_freeRenderImagesRequest, ::octaneapi::ApiRenderEngine_freeRenderImagesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_freeRenderImages_, context, request, response, std::move(f));
}

void ApiRenderEngineService::Stub::async::freeRenderImages(::grpc::ClientContext* context, const ::octaneapi::ApiRenderEngine_freeRenderImagesRequest* request, ::octaneapi::ApiRenderEngine_freeRenderImagesResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_freeRenderImages_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::octaneapi::ApiRenderEngine_freeRenderImagesResponse>* ApiRenderEngineService::Stub::PrepareAsyncfreeRenderImagesRaw(::grpc::ClientContext* context, const ::octaneapi::ApiRenderEngine_freeRenderImagesRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::octaneapi::ApiRenderEngine_freeRenderImagesResponse, ::octaneapi::ApiRenderEngine_freeRenderImagesRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_freeRenderImages_, context, request);
}

::grpc::ClientAsyncResponseReader< ::octaneapi::ApiRenderEngine_freeRenderImagesResponse>* ApiRenderEngineService::Stub::AsyncfreeRenderImagesRaw(::grpc::ClientContext* context, const ::octaneapi::ApiRenderEngine_freeRenderImagesRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncfreeRenderImagesRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
ApiRenderEngineService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ApiRenderEngineService::Service, ::octaneapi::ApiRenderEngine_freeRenderImagesRequest, ::octaneapi::ApiRenderEngine_freeRenderImagesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ApiRenderEngineService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::octaneapi::ApiRenderEngine_freeRenderImagesRequest* req,
             ::octaneapi::ApiRenderEngine_freeRenderImagesResponse* resp) {
               return service->freeRenderImages(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ApiRenderEngineService_method_names[127],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
...
::grpc::Status ApiRenderEngineService::Service::freeRenderImages(::grpc::ServerContext* context, const ::octaneapi::ApiRenderEngine_freeRenderImagesRequest* request, ::octaneapi::ApiRenderEngine_freeRenderImagesResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
