...
ApiItemArrayService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_get1_(ApiItemArrayService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status ApiItemArrayService::Stub::get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::octaneapi::ApiItemArray_getResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::octaneapi::ApiItemArray_getRequest, ::octaneapi::ApiItemArray_getResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_get1_, context, request, response);
}

void ApiItemArrayService::Stub::async::get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::octaneapi::ApiItemArray_getRequest, ::octaneapi::ApiItemArray_getResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_get1_, context, request, response, std::move(f));
}

void ApiItemArrayService::Stub::async::get1(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::octaneapi::ApiItemArray_getResponse>* ApiItemArrayService::Stub::PrepareAsyncget1Raw(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::octaneapi::ApiItemArray_getResponse, ::octaneapi::ApiItemArray_getRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_get1_, context, request);
}

::grpc::ClientAsyncResponseReader< ::octaneapi::ApiItemArray_getResponse>* ApiItemArrayService::Stub::Asyncget1Raw(::grpc::ClientContext* context, const ::octaneapi::ApiItemArray_getRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status ApiItemArrayService::Service::get1(::grpc::ServerContext* context, const ::octaneapi::ApiItemArray_getRequest* request, ::octaneapi::ApiItemArray_getResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
