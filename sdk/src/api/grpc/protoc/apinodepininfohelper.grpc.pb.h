...
class ApiNodePinInfoExService final {
 public:
  ...
  typedef WithAsyncMethod_createApiNodePinInfoArray<WithAsyncMethod_createApiNodePinInfo<WithAsyncMethod_deleteApiNodePinInfo<WithAsyncMethod_updateApiNodePinInfo<Service > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_createApiNodePinInfoArray<WithCallbackMethod_createApiNodePinInfo<WithCallbackMethod_deleteApiNodePinInfo<WithCallbackMethod_updateApiNodePinInfo<Service > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_createApiNodePinInfoArray<WithStreamedUnaryMethod_createApiNodePinInfo<WithStreamedUnaryMethod_deleteApiNodePinInfo<WithStreamedUnaryMethod_updateApiNodePinInfo<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_createApiNodePinInfoArray<WithStreamedUnaryMethod_createApiNodePinInfo<WithStreamedUnaryMethod_deleteApiNodePinInfo<WithStreamedUnaryMethod_updateApiNodePinInfo<Service > > > > StreamedService;
};
