...
static const char* ApiInfoService_method_names[] = {
  ...
  "/octaneapi.ApiInfoService/renderPassBlendingModeName",
...
ApiInfoService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_renderPassBlendingModeName_(ApiInfoService_method_names[39], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getAllRenderPassIds_(ApiInfoService_method_names[40], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getRenderPassIdFromRenderAovNode_(ApiInfoService_method_names[41], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_getRenderAovInfoFromRenderAovNode_(ApiInfoService_method_names[42], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_renderPassName_(ApiInfoService_method_names[43], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_renderPassShortName_(ApiInfoService_method_names[44], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_renderPassIdToPinId_(ApiInfoService_method_names[45], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_renderPassGroupName_(ApiInfoService_method_names[46], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_pinIdToRenderPassId_(ApiInfoService_method_names[47], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_findPinIdForRenderPassId_(ApiInfoService_method_names[48], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_findRenderPassIdForPinId_(ApiInfoService_method_names[49], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status ApiInfoService::Stub::renderPassBlendingModeName(::grpc::ClientContext* context, const ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest& request, ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest, ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_renderPassBlendingModeName_, context, request, response);
}

void ApiInfoService::Stub::async::renderPassBlendingModeName(::grpc::ClientContext* context, const ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest* request, ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest, ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_renderPassBlendingModeName_, context, request, response, std::move(f));
}

void ApiInfoService::Stub::async::renderPassBlendingModeName(::grpc::ClientContext* context, const ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest* request, ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_renderPassBlendingModeName_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse>* ApiInfoService::Stub::PrepareAsyncrenderPassBlendingModeNameRaw(::grpc::ClientContext* context, const ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse, ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_renderPassBlendingModeName_, context, request);
}

::grpc::ClientAsyncResponseReader< ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse>* ApiInfoService::Stub::AsyncrenderPassBlendingModeNameRaw(::grpc::ClientContext* context, const ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncrenderPassBlendingModeNameRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
ApiInfoService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ApiInfoService::Service, ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest, ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ApiInfoService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest* req,
             ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse* resp) {
               return service->renderPassBlendingModeName(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ApiInfoService_method_names[49],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
...
::grpc::Status ApiInfoService::Service::renderPassBlendingModeName(::grpc::ServerContext* context, const ::octaneapi::ApiInfo_renderPassBlendingModeNameRequest* request, ::octaneapi::ApiInfo_renderPassBlendingModeNameResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
