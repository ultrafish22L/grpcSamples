...
class StreamCallbackService final {
 public:
  ...
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    std::unique_ptr< ::grpc::ClientReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>> callbackChannel(::grpc::ClientContext* context) {
      return std::unique_ptr< ::grpc::ClientReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>>(callbackChannelRaw(context));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>> AsynccallbackChannel(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>>(AsynccallbackChannelRaw(context, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>> PrepareAsynccallbackChannel(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>>(PrepareAsynccallbackChannelRaw(context, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      virtual void callbackChannel(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::octaneapi::StreamCallbackResponse,::octaneapi::StreamCallbackRequest>* reactor) = 0;
    };
    typedef class async_interface experimental_async_interface;
    virtual class async_interface* async() { return nullptr; }
    class async_interface* experimental_async() { return async(); }
   private:
    virtual ::grpc::ClientReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>* callbackChannelRaw(::grpc::ClientContext* context) = 0;
    virtual ::grpc::ClientAsyncReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>* AsynccallbackChannelRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncReaderWriterInterface< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>* PrepareAsynccallbackChannelRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
    std::unique_ptr< ::grpc::ClientReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>> callbackChannel(::grpc::ClientContext* context) {
      return std::unique_ptr< ::grpc::ClientReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>>(callbackChannelRaw(context));
    }
    std::unique_ptr<  ::grpc::ClientAsyncReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>> AsynccallbackChannel(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>>(AsynccallbackChannelRaw(context, cq, tag));
    }
    std::unique_ptr<  ::grpc::ClientAsyncReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>> PrepareAsynccallbackChannel(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>>(PrepareAsynccallbackChannelRaw(context, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      void callbackChannel(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::octaneapi::StreamCallbackResponse,::octaneapi::StreamCallbackRequest>* reactor) override;
     private:
      friend class Stub;
      explicit async(Stub* stub): stub_(stub) { }
      Stub* stub() { return stub_; }
   ...
   private:
    std::shared_ptr< ::grpc::ChannelInterface> channel_;
    class async async_stub_{this};
    ::grpc::ClientReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>* callbackChannelRaw(::grpc::ClientContext* context) override;
    ::grpc::ClientAsyncReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>* AsynccallbackChannelRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncReaderWriter< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>* PrepareAsynccallbackChannelRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status callbackChannel(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::octaneapi::StreamCallbackRequest, ::octaneapi::StreamCallbackResponse>* stream);
  };
  template <class BaseClass>
  class WithAsyncMethod_callbackChannel : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status callbackChannel(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::octaneapi::StreamCallbackRequest, ::octaneapi::StreamCallbackResponse>* /*stream*/)  override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestcallbackChannel(::grpc::ServerContext* context, ::grpc::ServerAsyncReaderWriter< ::octaneapi::StreamCallbackRequest, ::octaneapi::StreamCallbackResponse>* stream, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithCallbackMethod_callbackChannel : public BaseClass {
   ...
   public:
    WithCallbackMethod_callbackChannel() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackBidiHandler< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>(
            [this](
                   ::grpc::CallbackServerContext* context) { return this->callbackChannel(context); }));
    }
    ...
    virtual ::grpc::ServerBidiReactor< ::octaneapi::StreamCallbackResponse, ::octaneapi::StreamCallbackRequest>* callbackChannel(
  ...
  class WithRawMethod_callbackChannel : public BaseClass {
   ...
   public:
    ...
    void RequestcallbackChannel(::grpc::ServerContext* context, ::grpc::ServerAsyncReaderWriter< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* stream, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncBidiStreaming(0, context, stream, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawCallbackMethod_callbackChannel : public BaseClass {
   ...
   public:
    ...
    virtual ::grpc::ServerBidiReactor< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* callbackChannel(
      ::grpc::CallbackServerContext* /*context*/)
      { return nullptr; }
  };
