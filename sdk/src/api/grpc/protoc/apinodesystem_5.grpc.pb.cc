...
ApiNodeArrayService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_get2_(ApiNodeArrayService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status ApiNodeArrayService::Stub::get2(::grpc::ClientContext* context, const ::octaneapi::ApiNodeArray_getRequest& request, ::octaneapi::ApiNodeArray_getResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::octaneapi::ApiNodeArray_getRequest, ::octaneapi::ApiNodeArray_getResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_get2_, context, request, response);
}

void ApiNodeArrayService::Stub::async::get2(::grpc::ClientContext* context, const ::octaneapi::ApiNodeArray_getRequest* request, ::octaneapi::ApiNodeArray_getResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::octaneapi::ApiNodeArray_getRequest, ::octaneapi::ApiNodeArray_getResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_get2_, context, request, response, std::move(f));
}

void ApiNodeArrayService::Stub::async::get2(::grpc::ClientContext* context, const ::octaneapi::ApiNodeArray_getRequest* request, ::octaneapi::ApiNodeArray_getResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::octaneapi::ApiNodeArray_getResponse>* ApiNodeArrayService::Stub::PrepareAsyncget2Raw(::grpc::ClientContext* context, const ::octaneapi::ApiNodeArray_getRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::octaneapi::ApiNodeArray_getResponse, ::octaneapi::ApiNodeArray_getRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_get2_, context, request);
}

::grpc::ClientAsyncResponseReader< ::octaneapi::ApiNodeArray_getResponse>* ApiNodeArrayService::Stub::Asyncget2Raw(::grpc::ClientContext* context, const ::octaneapi::ApiNodeArray_getRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status ApiNodeArrayService::Service::get2(::grpc::ServerContext* context, const ::octaneapi::ApiNodeArray_getRequest* request, ::octaneapi::ApiNodeArray_getResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
