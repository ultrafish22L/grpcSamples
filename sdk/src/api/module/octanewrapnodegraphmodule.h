...
namespace OctaneWrap
{
        ...
        const Octane::NodePinType outType)
    {
        ...
        Octane::ApiNodeGraphModuleInfo *const info = Octane::ApiNodeGraphModuleInfo::create(
            moduleId, 
            fullName, 
            description, 
            author, 
        ...
        if (isStaticallyLinked)
        {
            ...
            Octane::registerStaticNodeGraphModule(*info);
        }
        else
        {
            // register as dynamically linked module
            Octane::registerNodeGraphModule(*info);
        }
